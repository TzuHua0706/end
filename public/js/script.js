$(document).ready(function(){
    ...
    // Initialize Firebase
    var config = {
        apiKey: "AIzaSyCEz2iMo6e_Ryy6HTB3AZrWTb19o3tEq34",
        authDomain: "final-61e58.firebaseapp.com",
        databaseURL: "https://final-61e58.firebaseio.com",
        storageBucket: "final-61e58.appspot.com",
        messagingSenderId: "218549249647"
      };
  ...
  chatRoomRef.limitToLast(10).on('child_added',function(snapshot){
      ...
      if(uid===user.uid){
        ...
        $messageLi.css("margin-left","43vw");
